...
ecdfIEEE<- function(n,f_from,f_to){
  ...
  plot(budgetSteps,minCountDESv2/(ecdfMaxSucess),xlab="",ylab="",ylim=c(0, 1),type="b", lwd=2,lty=linetype[1], col=colors[1], pch=plotchar[1])
  ...
  lines(budgetSteps,minCountjso/(ecdfMaxSucess),type="b", lwd=2,lty=linetype[4], col=colors[4], pch=plotchar[4])
