results <- function(){
  ...
  resmatrix <- matrix(0, nrow=1002, ncol=12)
  ...
  resRank <- 12-(resRank/1000)
  resRank <- t(resRank)
  colnames(resRank) <- c("CMADEv51", "CMADEv52", "CMADEv53", "CMADEv54", "CMADEv55", "CMADEv56", "CMADEv57", "CMADEv58", "CMADEv59", "CMADEv595", "CMADEv596", "CMADEv597")
  print(resRank)
